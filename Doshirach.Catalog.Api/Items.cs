...
public static class Items
{
	...
	{
		app.MapGet("categories/{categoryId}/items", 
			[Authorize(Roles = "Manager, Buyer")]
			async ([FromServices] CatalogService catalogService, int categoryId, int? page, int? perPage) =>
			{
		...
		app.MapGet("categories/{categoryId}/items/{id}", 
			[Authorize(Roles = "Manager, Buyer")]
			async ([FromServices] CatalogService catalogService, int categoryId, int id) =>
			{
		...
		app.MapPost("categories/{categoryId}/items", 
			[Authorize(Roles = "Manager")]
			async ([FromServices] CatalogService catalogService, Item item) =>
			{
		...
		app.MapPut("categories/{categoryId}/items/{id}", 
			[Authorize(Roles = "Manager")]
			async ([FromServices] CatalogService catalogService, Item item) =>
			{
		...
		app.MapDelete("categories/{categoryId}/items/{id}", 
			[Authorize(Roles = "Manager")]
			async ([FromServices] CatalogService catalogService, int categoryId, int id) =>
			{
